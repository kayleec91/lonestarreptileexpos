...
export function getDefaultFaqs(cityOrVenue = "") {
  ...
  return [
    ...
    },
    {
      ...
      answer: hasAtm
        ? "Yes, an ATM is available at this location."
        : "Not at this location. We recommend bringing cash because some vendors may not accept cards.",
    },
    {
      question: "Do vendors accept cards?",
      answer:
        "Many vendors accept cards, but bringing cash is recommended.",
    },
  ];
}
...
export const events: Event[] = [
  {
    ...
    vendorListLink:
      "https://www.lonestarreptileexpos.com/nrhvendors",
    registerLink:
      "/vendor-registration?event=nrh-may-2026",
    status: "active",
    featured: true,
  ...
  },
  {
    ...
    vendorListLink:
      "https://www.lonestarreptileexpos.com/vendors",
    registerLink:
      "/vendor-registration?event=arlington-jul-2026",
    status: "active",
  ...
  },
  {
    ...
    vendorListLink:
      "http://lonestarreptileexpos.com/colemanvendors",
    registerLink:
      "/vendor-registration?event=coleman-jul-2026",
    status: "active",
  ...
  },
  {
    ...
    vendorListLink:
      "https://www.lonestarreptileexpos.com/vendors-amarillo",
    registerLink:
      "/vendor-registration?event=amarillo-oct-2026",
    status: "active",
  ...
  },
  {
    ...
    vendorListLink:
      "https://www.lonestarreptileexpos.com/sanantoniovendors",
    registerLink:
      "/vendor-registration?event=san-antonio-oct-2026",
    status: "active",
  ...
  },
  {
    ...
    vendorListLink:
      "https://www.lonestarreptileexpos.com/nrhvendors",
    registerLink:
      "/vendor-registration?event=nrh-nov-2026",
    status: "active",
    faqs: getDefaultFaqs("North Richland Hills"),
  },
];
