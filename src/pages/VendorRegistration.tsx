...
const tablePricingByLocation: Record<string, Array<{ label: string; value: string }>> = {
  arlington: [
    ...
    { label: "Additional 8ft tables - $50 each", value: "Arlington - additional 8ft tables - $50 each" },
  ],
  amarillo: [
    ...
    { label: "Additional 8ft tables - $50 each", value: "Amarillo - additional 8ft tables - $50 each" },
  ],
  schertz: [
    ...
    { label: "Additional 6ft tables - $50 each", value: "Schertz - additional 6ft tables - $50 each" },
  ],
  "north richland hills": [
    ...
    { label: "Additional 8ft tables - $50 each", value: "North Richland Hills - additional 8ft tables - $50 each" },
  ],
};
